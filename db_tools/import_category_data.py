...
pwd = os.path.dirname(os.path.realpath(__file__))  # 获取当前运行文件所在目录
sys.path.append(pwd + "../")  # 将pwd加入python的搜索目录之下
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "MxShop.settings")

django.setup()

from goods.models import GoodsCategory  # 只有在django setup之后才能进行导入
